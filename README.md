...
| **facebook/convnext-base** | 9.42 | 0.0964 | ~88M |
...
| **ConvNext-Base** | `dog` | 97.8%* | 5.67 |

*\*Confidence estimated from test accuracy.*
...
- `task1_convnext_train.py`: Specialized training script for ConvNext-Base.
- `inference_compare.py`: Benchmark script for speed and accuracy comparison.
- `inference_convnext.py`: Throughput benchmark for ConvNext.
